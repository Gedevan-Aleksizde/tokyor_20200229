...
1. 中国の武漢中心に新型コロナウィルス(COVID-19)が流行
...
# なぜシミュレーションか?
[@peng2020Epidemic]
> 統計モデルに対動学方程式の数理モデルは注目されないが, 伝染病動学のより詳しいメカニズムを得ることができる
...
* 感染者より回復者のほうが増えるスピードが速ければ感染者は増えないので
* 感染初期はほとんど感染者がいない
...
* $R_0$が小さかったらパンデミックは起こらない

# 現実に置き換えると
* COVID-19は **飛沫感染と接触感染のリスクが高いとされる**(厚労省)
* 人間同士の距離が近く, より多くの人間と接触があるほど感染力が$\beta$が増加
* $R_0>1$は**人口密度が一定の値を超えるかどうか**を表している
* 外出を避け繁華街を出歩かないようにすることはパンデミックの抑止に効果がある
